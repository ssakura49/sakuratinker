...
public class SPELL_ATTR extends Modifier implements CurioAttributeModifierHook {
    @Override
    ...
    public void modifyCurioAttribute(IToolStackView curio, ModifierEntry entry, SlotContext context, UUID uuid, BiConsumer<Attribute, AttributeModifier> consumer) {
        consumer.accept(AttributeRegistry.SPELL_POWER.get(), new AttributeModifier(uuid, "spell_power_attr", 0.1f*entry.getLevel(), AttributeModifier.Operation.ADDITION));
    }
}
