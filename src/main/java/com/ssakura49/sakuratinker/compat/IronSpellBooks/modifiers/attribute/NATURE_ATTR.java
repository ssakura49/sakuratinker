...
public class NATURE_ATTR extends Modifier implements CurioAttributeModifierHook {
    private static final UUID ID = UUID.fromString("e1d38d62-05d0-42b6-9d3c-37edb08195a1");
    @Override
    ...
    public void modifyCurioAttribute(IToolStackView curio, ModifierEntry entry, SlotContext context, UUID uuid, BiConsumer<Attribute, AttributeModifier> consumer) {
        consumer.accept(AttributeRegistry.NATURE_SPELL_POWER.get(), new AttributeModifier(ID, "nature_attr", 0.1f*entry.getLevel(), AttributeModifier.Operation.ADDITION));
    }
}
