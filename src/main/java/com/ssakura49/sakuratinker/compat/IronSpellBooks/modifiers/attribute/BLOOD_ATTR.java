...
public class BLOOD_ATTR extends Modifier implements CurioAttributeModifierHook {
    private static final UUID ID = UUID.fromString("e3d32d91-05d0-42b6-9d3c-37edb07095a1");
    @Override
    ...
    public void modifyCurioAttribute(IToolStackView curio, ModifierEntry entry, SlotContext context, UUID uuid, BiConsumer<Attribute, AttributeModifier> consumer) {
        consumer.accept(AttributeRegistry.BLOOD_SPELL_POWER.get(), new AttributeModifier(ID, "blood_attr", 0.1f*entry.getLevel(), AttributeModifier.Operation.ADDITION));
    }
}
