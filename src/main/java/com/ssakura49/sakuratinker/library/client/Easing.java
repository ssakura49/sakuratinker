...
public interface Easing {
    Easing IN_SINE
            = x -> 1 - MathUtils.cos((float) ((x * Math.PI) / 2));
    Easing OUT_SINE
            = x -> MathUtils.sin((float) ((x * Math.PI) / 2));
    Easing IN_OUT_SINE
            = x -> -(MathUtils.cos((float) (Math.PI * x)) - 1) / 2;
    Easing IN_QUAD
            = x -> x * x;
    Easing OUT_QUAD
            = x -> 1 - (1 - x) * (1 - x);
    ...
    Easing INVERSE_OUT_CUBIC
            = x -> (float) (Math.pow(1 - x, 3));
    Easing IN_OUT_CUBIC
    ...
    Easing IN_ELASTIC
        ...
        return x == 0
                ...
                : (float) (x == 1
                ? 1
                : -Math.pow(2, 10 * x - 10) * MathUtils.sin((float) ((x * 10 - 10.75) * c4)));
    };
    Easing OUT_ELASTIC
            = x -> {
        ...
        return x == 0
                ...
                : (float) (x == 1
                ? 1
                : Math.pow(2, -10 * x) * MathUtils.sin((float) ((x * 10 - 0.75) * c4)) + 1);
    };
    Easing IN_OUT_ELASTIC
            = x -> {
        float c5 = (float) ((2 * Math.PI) / 4.5);
        double v = MathUtils.sin((float) ((20 * x - 11.125) * c5));
        return x == 0
                ? 0
                : (float) (x == 1
                ? 1
