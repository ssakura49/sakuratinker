...
//    public static final MaterialStatsId FOX_MASK = new MaterialStatsId(SakuraTinker.location("fox_mask"));
    ...
    public static final MaterialStatsId YO_YO = new MaterialStatsId(SakuraTinker.location("yo_yo"));
    public static final MaterialStatsId TINKER_WAND = new MaterialStatsId(SakuraTinker.location("tinker_wand"));
    public static final MaterialStatsId ALCHEMICAL_GLOVES = new MaterialStatsId(SakuraTinker.location("alchemical_gloves"));

    public static final MaterialStatsId RANGE = new MaterialStatsId(SakuraTinker.location("range"));
