...
public class LootTableTemplate {
    ...
    public static LootItemCondition.Builder shearOrSilk(boolean inverted) {
        AnyOfCondition.Builder ans = AnyOfCondition.anyOf(new LootItemCondition.Builder[]{MatchTool.toolMatches(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(Tags.Items.SHEARS)), MatchTool.toolMatches(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().hasEnchantment(hasEnchantment(Enchantments.SILK_TOUCH, 1)))});
        return (LootItemCondition.Builder)(inverted ? ans.invert() : ans);
    }

    public static LootItemCondition.Builder silk(boolean inverted) {
        LootItemCondition.Builder ans = MatchTool.toolMatches(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().hasEnchantment(hasEnchantment(Enchantments.SILK_TOUCH, 1)));
