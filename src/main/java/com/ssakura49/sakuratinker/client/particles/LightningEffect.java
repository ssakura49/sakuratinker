package com.ssakura49.sakuratinker.client.particles;
...
/***
 * This class is based of BoltRenderer Code from Botania: "<a href="https://github.com/VazkiiMods/Botania/blob/1.20.x/Xplat/src/main/java/vazkii/botania/client/fx/BoltRenderer.java">...</a>">...</a>
 */
public class LightningEffect {
    ...
    public static void onWorldRenderLast(Camera camera, float partialTicks, PoseStack ps, RenderBuffers buffers) {
        ...
        bufferSource.endBatch(STRenderType.LIGHTNING);
        ps.popPose();
    }

    public void render(float partialTicks, PoseStack matrixStack, MultiBufferSource buffers) {
        if (Minecraft.getInstance().level != null) {
            VertexConsumer buffer = buffers.getBuffer(STRenderType.LIGHTNING);
