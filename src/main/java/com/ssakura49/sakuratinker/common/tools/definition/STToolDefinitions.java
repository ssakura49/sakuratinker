...
public class STToolDefinitions {
    ...
    public static final ToolDefinition YOYO = ToolDefinition.create(STItems.yoyo);
    public static final ToolDefinition SCYTHE = ToolDefinition.create(STItems.scythe);
