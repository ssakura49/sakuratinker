...
public class NihiliteItem extends Item {
    public NihiliteItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(DynamicComponentUtil.WaveColorText.getColorfulText(
                    "tooltip.sakuratinker.nihilite_ingot.line1",
                    null,
                    CommonRGBUtil.darkPurple.getRGB(),
                    40,
                    1000,
                    true
            ));
